import { Interface } from "ethers/src.ts/abi/index.js";
import { Log, TransactionResponse } from "ethers/src.ts/providers/provider.js";
import { ContractTransactionResponse, EventLog } from "ethers/src.ts/contract/wrappers.js";
import type { EventFragment, FunctionFragment, InterfaceAbi, ParamType } from "ethers/src.ts/abi/index.js";
import type { Addressable } from "ethers/src.ts/address/index.js";
import type { EventEmitterable, Listener } from "ethers/src.ts/utils/index.js";
import type { BlockTag, ContractRunner } from "ethers/src.ts/providers/index.js";
import type { ContractEventName, ContractInterface, ContractMethod, ContractEvent, ContractTransaction, WrappedFallback } from "ethers/src.ts/contract/types.js";
/**
 *  @_ignore:
 */
