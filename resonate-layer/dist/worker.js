...
const scoreProposal_1 = require("./functions/scoreProposal");
const fetchVotes_1 = require("./functions/fetchVotes");
const getReputations_1 = require("./functions/getReputations");
const checkEligibility_1 = require("./functions/checkEligibility");
const calculateScore_1 = require("./functions/calculateScore");
...
async function main() {
    ...
    resonate.register('scoreProposal', scoreProposal_1.scoreProposal);
    console.log('  ✓ scoreProposal');
    // Sub-functions (each becomes a durable child promise)
    resonate.register('fetchVotes', fetchVotes_1.fetchVotes);
    console.log('  ✓ fetchVotes');
    resonate.register('getReputations', getReputations_1.getReputations);
    console.log('  ✓ getReputations');
    resonate.register('checkEligibility', checkEligibility_1.checkEligibility);
    console.log('  ✓ checkEligibility');
    resonate.register('calculateScore', calculateScore_1.calculateScore);
